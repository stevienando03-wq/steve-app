...
self.addEventListener("fetch", e => {
  ...
  if (req.mode === "navigate" || (req.headers.get("accept") || "").includes("text/html")) {
    e.respondWith(fetch(req).then(r => { caches.open(CACHE).then(c => c.put("./index.html", "./fiches.js", "./actu.js", "./entrainement.js", r.clone())); return r; }).catch(() => caches.match("./index.html")));
    return;
  }
  // reste : cache d'abord
